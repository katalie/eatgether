          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li class="active"><a href="#">当前订单</a></li>
                          <li><a href="/eat/orders/viewCurrentChefList">厨师总备菜单</a></li>
                          <li class="sub-menu">
                              <a  href="javascript:;">厨师分地点备菜单</a>
                              <ul class="sub">
                  ...
                  <div class="col-lg-12">
                      <section class="panel">
                          <header class="panel-heading">
                              当前订单 (<?php echo $orderTime["startTime"]. ' 到 ' . $orderTime["endTime"]?>) 
                          </header>
                          <div class="panel-body">
                                <div class="adv-table">
                                    <table  class="display table table-bordered table-striped" id="example">
                                      ...
                                      <tr class="gradeX">
                                          <td><?php echo $orders[$key]['Order']['order_serial'] ?></td>
                                          <td><?php echo $orders[$key]['Customer']['telephone'] ?></td>
                                          <td>$<?php echo $orders[$key]['Order']['total'] ?></td>
                                          <td><?php echo $orders[$key]['Location']['name'] ?></td>
                                          <td><?php echo $orders[$key]['Order']['state']==1?'是':'否' ?></td>
                                          <td><?php echo $orders[$key]['Order']['delivered_time']==null?'N/A':$orders[0]['Order']['delivered_time'] ?></td>
                                      </tr>
                                      <?php } ?>
                                      </tbody>
                                      <tfoot>
                              ...
                              <header class="panel-heading">总价：$<?php echo $grandTotal?></header>
                          </div>
                      </section>
                  </div>
              </div>
